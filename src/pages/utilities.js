...
const title     = 'Utility classes',
    description = 'In addition to its grid system and style resets, chassis.css provides verbose and easy-to-use utility classes to manipulate just above everything. If there\'s something you need to adjust, there\'s probably a utility class for you!';
